    ...
    return (
        <div className="shadow-md pt-6 pb border-solid border-b-2 border-coffee_5 bg-white text-center w-full fixed top-0 left-0 z-10">
            ...
            <ul className="p-6 flex text-coffee_5 justify-center gap-6 w-full text-left">
                <li><a className="border-white p-2 border-b-2 hover:border-coffee_5 font-semibold" href="/">All Projects</a></li>
                ...
                <li><a className="p-2 border-b-2 border-white hover:border-coffee_5 font-semibold" href="/admin">Admin</a></li>
            </ul>
        </div>
    );
};